...
type ServerConfig struct {
	...
	GoodsSrvInfo     GoodsSrvConfig `mapstructure:"goods_svc" json:"goods_svc"`
	OrderSrvInfo     GoodsSrvConfig `mapstructure:"order_svc" json:"order_svc"`
	InventorySrvInfo GoodsSrvConfig `mapstructure:"inventory_svc" json:"inventory_svc"`
